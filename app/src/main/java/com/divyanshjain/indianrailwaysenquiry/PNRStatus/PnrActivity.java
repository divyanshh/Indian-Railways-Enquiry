...
public class PnrActivity extends AppCompatActivity {
    ...
    String URL = "https://api.railwayapi.com/v2/pnr-status/pnr/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String pnrNo = bundle.getString("pnrNo");
        String finalUrl = URL+pnrNo+"/apikey/1fg74i4g4f/";
        URL = finalUrl;
        Log.i("URL" , URL);
                    ...
                    public void onResponse(String s) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                PNRListItem item = new PNRListItem(
                                        o.getString("no"),
                            ...
                            adapter = new PNRAdapter(listItems, getApplicationContext());
